...
import in.co.sattamaster.ui.AddModerator.AddModeratorMvpPresenter;
import in.co.sattamaster.ui.AddModerator.AddModeratorMvpView;
import in.co.sattamaster.ui.AddModerator.AddModeratorPresenter;
...
import in.co.sattamaster.ui.Transactions.TransactionMvpPresenter;
import in.co.sattamaster.ui.Transactions.TransactionMvpView;
import in.co.sattamaster.ui.Transactions.TransactionPresenter;
...
public class ActivityModule {
    ...
    @Provides
    TransactionMvpPresenter<TransactionMvpView> provideTransactionMvpPresenter(
            TransactionPresenter<TransactionMvpView> presenter) {
        return presenter;
    }
    ...
    @Provides
    AddModeratorMvpPresenter<AddModeratorMvpView> provideAddModeratorMvpPresenter(
            AddModeratorPresenter<AddModeratorMvpView> presenter) {
        return presenter;
    }

    @Provides
    ListOfModeratorMvpPresenter<ListOfModeratorMvpView> provideListOfModeratorMvpPresenter(
            ListOfModeratorPresenter<ListOfModeratorMvpView> presenter) {
        return presenter;
    }
